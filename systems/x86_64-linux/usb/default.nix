...
# NOTE temp config for dev box that is installed on a usb stick
{
  imports = [
    ...
    # TODO bekijken hardware specific for laptop
  ...
  desktop.hyprland.monitors = {
    "DP-7" = {
      ...
      width = 2560;
      height = 1440;
      refreshRate = 60.; # TODO connect with DP to monitor to get 144Hz
      # y = -720;
      # x = -2560; # FIXME only one that is correct (but does not do exactly what I want)
      # y = -;
      scale = 1.00;
    };
    "eDP-1" = {
  ...
  theming.stylix.enable = true; # TODO verplaatsen?
  ...
  # TODO move this to x86_64-linux?

  # services.onedrive.enable = true; # TODO nextcloud proberen of dit opnieuw proberen
